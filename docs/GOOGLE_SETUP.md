...
2. Fill in app name, support email, and the branding URLs: home page `https://sirenes.vivedo.me/`, privacy policy `https://sirenes.vivedo.me/privacy.html`, terms of service `https://sirenes.vivedo.me/terms.html`. Both pages are plain static HTML with no scripts, as Google's reviewers expect, and the privacy policy states the `drive.file` scope, what is read and written, and Limited Use compliance.
